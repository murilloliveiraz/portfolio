const Navbar = () => {
  return (
    <header className="flex justify-center mt-3">   
        <nav className="container mx-auto mt-8 h-16 w-full max-w-[1024px] items-center justify-between rounded-xl border-[1px] border-white/25 bg-white/25 px-4 backdrop-blur-md dark:border-card-border/20 dark:bg-[#18181D]/30">
